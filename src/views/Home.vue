        ...
        <div class="home_box">
            <div class="clef_box">
                ...
                <div class="btn_group">
                    <div
                        class="img_box"
                        v-for="(item, index) in clefArr"
                        :key="index"
                    >
                        <img
                            :src="item.img"
                            alt
                            @click="addNote(item.data)"
                        />
                    </div>
                    <div
                        class="img_box"
                        v-for="(item, index) in restArr"
                        :key="index+'a'"
                    >
                        <img
                            :src="item.img"
                            alt
                            @click="addRestNote(item.data)"
                        />
                    </div>
                    <div class="img_box">
                        <img
                            src="../assets/image/barline.png"
                            alt
                            @click="addBarline()"
                        />
                    </div>
    ...
    public keypressHandle(e: KeyboardEvent) {
        if (
            ...
            this.selectedNotation &&
                (this.selectedNotation as Note).pitchDown();
        }
    }
    public newline() {
